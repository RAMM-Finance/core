...
//     // function doApprove(address vault, address validator) public {
//     //     // approve vault tokens
//     //     uint256 initialStake = c.getInitialStake(1);
//     //     uint256 assetToMint = Vault(vault).convertToAssets();
//     //     vm.startPrank(validator);
//     //     cash.faucet(assetToMint);
//     //     Vault(vault).mint(initialStake);
//     //     ERC20(vault).approve(address(c),initialStake);

//     //     // approve discount amount
//     //     (uint256 N, , , , , , , ) = mm.parameters(1);
//     //     uint256 zcb_for_sale = valdata.val_cap / N;
//     //     uint256 collateral_required = zcb_for_sale.mulWadDown(
//     //         valdata.avg_price
//     //     );
//     //     cash.faucet(collateral_required);
//     //     ERC20(address(cash)).approve(address(mm), collateral_required);
